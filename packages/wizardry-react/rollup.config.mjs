...
import plugins from '@wizardry/rollup-plugins';
import pkg from './package.json' with {type: 'json'};
import dts from 'rollup-plugin-dts';

const packageName = 'WizardryReact';
const outputFileName = 'wizardry-react';
const inputs = [`src/wizardry-react.ts`];
const bundles = [
    {
        format: 'umd',
        inputs,
    ...
    {
        format: 'esm',
        inputs: [...inputs, 'src/dynamicIconImports.ts', 'src/DynamicIcon.ts'],
        outputDir: 'dist/esm',
