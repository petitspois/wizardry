...
export interface WizardryProps extends ElementAttributes {
  size?: string | number;
  absoluteStrokeWidth?: boolean;
}

export type WizardryIcon = ForwardRefExoticComponent<
  Omit<WizardryProps, 'ref'> & RefAttributes<SVGSVGElement>
>;
